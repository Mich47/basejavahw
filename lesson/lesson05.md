...
- при поиске uuid не надо использовать методы, который сравнивают объекты com.mich.webapp.model.Resume по equals, в следующих уроках добавим еще поля в com.mich.webapp.model.Resume и в equals и данный вариант не подойдет
